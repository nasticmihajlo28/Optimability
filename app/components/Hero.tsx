...
const TITLE = "One System Completely Running Your Entire Health And Performance";
...
export default function Hero() {
  return (
    <section className="relative flex w-full flex-col items-center px-4 pt-16">
      <AmbientBackdrop />
      ...
      {/* CTA buttons */}
      <div
        className="hero-rise mt-10 flex flex-col items-center gap-4 sm:flex-row sm:gap-[1.875rem]"
