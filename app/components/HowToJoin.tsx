...
function CallVisual() {
  return (
    <>
      ...
      {/* Portrait photo */}
      <div className="absolute left-[calc(50%+6.5px)] top-[calc(50%+0.5px)] h-[222px] w-[177px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-lg">
        <Image
          src={callPortrait}
          alt="Sarah from Optimability smiling during an intro call"
          fill
          sizes="177px"
      ...
      {/* Call window */}
      <div className="absolute left-[calc(50%-29.5px)] top-[calc(50%-43px)] h-[87px] w-[241px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[4.893px] bg-white shadow-[1.223px_3.67px_7.34px_0px_rgba(0,0,0,0.28)]">
      ...
      {/* Portrait cutout popping over the call window */}
      <div className="pointer-events-none absolute left-[calc(50%+6.5px)] top-[calc(50%+0.5px)] h-[222px] w-[177px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-lg">
        <Image src={callPortraitCutout} alt="" aria-hidden fill sizes="177px" className="object-cover" />
      </div>
    </>
  );
}
