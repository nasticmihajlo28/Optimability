...
export const metadata: Metadata = {
  title: "Terms of Service — Optimability",
  description:
    "Terms of Service for Optimability Performance Solutions Inc.",
};
...
const SECTIONS: LegalSection[] = [
  ...
  {
    heading: "2. Services Provided (Tier 1)",
    body: [
  ...
  {
    heading: "3. Physical Services and the US Entity (Tier 2)",
    body: [
  ...
  {
    heading: "10. Independent Contractor Status",
    body: [
